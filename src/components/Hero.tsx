...
const Hero = () => {
  return (
    <section
      id="home"
      className="relative pt-24 pb-20 md:pt-32 md:pb-28 bg-gjm-green text-white overflow-hidden"
    >
      <div className="absolute inset-0 bg-gradient-to-r from-gjm-dark/70 to-gjm-green/50 z-10"></div>
      <div className="absolute inset-0 bg-[url('/lovable-uploads/edf5e569-019a-4c5b-8335-d0fdb5adb765.png')] bg-center bg-no-repeat bg-cover opacity-20"></div>
